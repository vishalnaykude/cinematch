...
if __name__ == "__main__":
    ...
    # Add movies
    system.add_movie("The summer i turned pretty", "Drama", 9.0)
    system.add_movie("Mismatch", "Drama", 8.7)
    system.add_movie("Space", "Sci-Fi", 8.6)
    system.add_movie("Crime petrol", "Crime", 9.2)
    system.add_movie("Fighter", "Action", 9.0)
    ...
    # Delete a movie
    system.delete_movie("Inception")  # Assuming "Inception" is in the list to be deleted for testing
